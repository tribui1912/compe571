...
def plot_results(results):
    ...
    plt.grid(True)
    plt.savefig('quantum_results_experiment_2.png')
    print("Plot saved as quantum_results_experiment_2.png")

if __name__ == "__main__":
    input_file = "experiment_2.txt"
    ...
    print(f"Shortest average response time: {best_quantum[1]:.2f} µs")
